<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" isELIgore="false"%>
...
<input type="hidden" name="membId" value="${dto.membId }">
	<table border="1" align="center">
		...
		<tr><td>생년월일</td>
			<td><fmt:formatDate value="${dto.membBirth }" type="date" pattern="yyyy-MM-dd"/></td></tr>	
		<tr><td>성별</td>
			<td>
		...
		<tr><td>이메일</td>
			<td><input type="email" name="membEmail" value="${dto.membEmail }"/></td></tr>	
		<tr><td>이메일 수신여부</td>
			<td>
				...
				<input type="radio" name="membConfirm" value="N"  
					<c:if test="${dto.membConfirm == 'N' }">checked</c:if>	/>아니요
			</td></tr>	
