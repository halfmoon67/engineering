...
<form action="memJoin" method="post" name="frm">
	<table border="1" align="center">
		...
		<tr><td>주소</td>
			<td><input type="text" name="membAddr" />
			<a href="javascript:sample4_execDaumPostcode();">주소검색
			</td></a></tr>	
		<tr><td>상세주소</td>
			<td><input type="text" name="detailAddr" id="sample4_roadAddress" /></td></tr>	
		<tr><td>연락처</td>
		...
		<tr><td>이메일</td>
			<td><input type="email" name="membEmail" /></td></tr>	
		<tr><td>이메일 수신여부</td>
			<td>
				<input type="radio" name="membConfirm" value="Y" />예
				<input type="radio" name="membConfirm" value="N" />아니요
			</td></tr>	
